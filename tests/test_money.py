...
class TestMoney(unittest.TestCase):
    ...
    def test_handle_value_round(self):
        self.assertEqual(Money.handle_value(10.777, 2 , roundv), 10.78)
        self.assertEqual(Money.handle_value(10.773, 2 , roundv), 10.77)
        self.assertEqual(Money.handle_value(10.77, 2 , roundv), 10.77)
